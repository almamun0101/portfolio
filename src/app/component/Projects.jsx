...
const techIcons = {
  ...
  Tailwind: (
    <div className="w-6 h-6 bg-cyan-400 rounded-full flex items-center justify-center text-white text-xs font-bold">
      T
    </div>
  ),
  Nextjs: (
  ...
  Firebase: (
    <div className="w-6 h-6 bg-red-400 rounded-full flex items-center justify-center text-white text-xs font-bold">
      F
    </div>
  ),
  Git: (
...
const Projects = () => {
  ...
  const handleViewMore = () => {
    setShowMore((prev) => Math.min(prev + 3, projects.length));
  };
  const handleShowLess = () => {
    setShowMore((prev) => Math.max(prev - 3, 6)); // minimum 6
  };
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] py-12 sm:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filteredProjects.slice(0, showMore).map((project, index) => {
              return (
                <motion.div
                  ...
                  <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 p-6 h-full transition-all duration-500 hover:border-yellow-400/50">
                    ...
                    <div className="flex gap-3 mt-auto">
                      <motion.a
                        ...
                        className="group relative px-5 py-2 bg-gradient-to-r from-gray-800 to-black rounded-full font-bold text-white border-2 border-yellow-400 hover:border-yellow-300 transition-all duration-300 shadow-lg hover:shadow-yellow-400/25"
                        whileHover={{
                          scale: 1.05,
                      ...
                      <motion.a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group relative flex-1 bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black px-4 py-2 rounded-lg font-bold text-center transition-all duration-300 shadow-lg hover:shadow-xl text-sm"
                        whileHover={{
                          scale: 1.05,
                          boxShadow: "0 0 25px rgba(250, 204, 21, 0.4)",
                        }}
        ...
        >
          <div className="group relative px-8 py-4 bg-gradient-to-r from-gray-800 to-black rounded-full font-bold text-white border-2 border-yellow-400 hover:border-yellow-300 transition-all duration-300 shadow-lg hover:shadow-yellow-400/25">
            <span className="relative z-10 flex items-center gap-3 text-lg">
              ...
              {showMore < projects.length && (
                <button onClick={handleViewMore}>Show More</button>
              )}
