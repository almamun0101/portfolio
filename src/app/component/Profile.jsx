  ...
  return (
     <div className="w-full bg-black text-white ">
       ...
       <div className="border border-gray-50 rounded-2xl bg-[#171717] py-10 px-10 w-3/4 mx-auto flex flex-col justify-center items-center">
            <div className="w-80  rounded-full bord-4  border-black">
            ...
            <h1 className='mt-6 text-5xl text-gold  font-bold'>Al Mamun Khan</h1>
            <p className='mt-2 text-white/60'>Web Designer || Web Developer || MEARN Dev</p>
            <button className='flex py-2 mt-4 bg-gold/10 text-gold animate-pulse hover:bg-gold transition duration-300 hover:text-white  items-center gap-5 border px-4 rounded-xl border-gold  '>Resume <FaFileDownload /></button>
        </div>
    </div>
  )
}
